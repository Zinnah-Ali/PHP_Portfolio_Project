				...
				<div class="page-header">
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Add Section Title</li>
						</ul>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title">Add Section Title</h5>
							...
							<div class="panel-body">
								...
								<?php } ?>
							<form class="form-horizontal" action="../controller/sectionsConfig.php" method="POST">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="page_no" id="page_no">
										</div>
									</div>
